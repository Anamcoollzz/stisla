@php
  ...
  $_nama_perusahaan = \App\Pengaturan::where('key', 'nama_perusahaan')->first()->value;
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="{{ asset('img/logo.png') }}" alt="{{ $_nama_aplikasi }}" width="80" class="shadow-light rounded-circle mb-5 mt-2">
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; {{ $_nama_perusahaan }}. Dibuat dengan 💙 Stisla
            </div>
          </div>
        </div>
